...
const Landing = () => {
  ...
  const fakeProfiles = [
    { 
      ...
      whyBook: 'Students should book with me because I bring a wealth of experience in software development, and I\'m dedicated to helping aspiring developers navigate the industry and achieve their career goals.'
    },
    { 
      name: 'Jane Smith', 
      ...
      whyBook: 'Students should book with me because I bring expertise in data science and analytics, and I\'m committed to mentoring students and sharing my knowledge to help them succeed in the field.'
    },
    { 
      name: 'Alex Johnson', 
      ...
      whyBook: 'Students should book with me because I excel in web development and UI/UX design, and I\'m committed to helping students build their portfolios and launch successful careers in tech.'
    },
    { 
      name: 'Emily Brown', 
      ...
      whyBook: 'Students should book with me because I have a passion for user experience design and a deep understanding of human-centered design principles. I\'m dedicated to helping students develop their design skills and create impactful user experiences.'
    },
    { 
      name: 'Michael Wil', 
      ...
      whyBook: 'Students should book with me because I bring expertise in digital marketing and analytics, and I\'m passionate about mentoring students and helping them develop their marketing skills in a real-world setting.'
    },
    { 
      name: 'Sarah Mart', 
      ...
      whyBook: 'Students should book with me because I have a strong track record in product management and a passion for innovation. I\'m committed to mentoring students and providing them with the skills and knowledge they need to succeed in the tech industry.'
    },
    { 
      name: 'David Lee', 
      ...
      whyBook: 'Students should book with me because I have extensive experience in financial analysis and a strong analytical mindset. I\'m dedicated to helping students develop their analytical skills and gain practical experience in finance.'
    },
    { 
      name: 'Jessica Tay', 
      ...
      whyBook: 'Students should book with me because I have a deep understanding of HR best practices and a commitment to promoting diversity and inclusion in the workplace. I\'m passionate about mentoring students and helping them develop the skills they need to succeed in their careers.'
    },
    { 
      name: 'Chris Garcia', 
      ...
      whyBook: 'Students should book with me because I have a passion for customer service and a talent for building rapport with clients. I\'m dedicated to helping students develop their sales skills and providing them with hands-on experience in a retail environment.'
    },
  ];  
...
<Dialog open={!!selectedProfile} onClose={handleCloseDialog}>
        ...
        <DialogContent>
          <Box display="flex" flexDirection="column" alignItems="flex-start">
            <Box width="100%" display="flex" alignItems="center" border={1} borderRadius={4} p={2} borderColor="grey.300">
            ...
            <Box width="100%" mt={2} display="flex" alignItems="flex-start" border={1} borderRadius={4} p={2} borderColor="grey.300">
              <Typography variant="subtitle1" component="span" fontWeight="bold">
                Bio:
              </Typography>
              <Typography variant="body1" component="span" marginLeft="2cm">
            ...
            <Box width="100%" mt={2} display="flex" alignItems="center" border={1} borderRadius={4} p={2} borderColor="grey.300">
              <Typography variant="subtitle1" component="span" fontWeight="bold">
                Why Book:
              </Typography>
              <Typography variant="body1" component="span" marginLeft="2cm">
